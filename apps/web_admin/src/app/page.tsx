    ...
    <AuthGuard>
      <AdminLayout>
        <div className="mb-8">
          ...
          <p className="mt-2 text-sm text-gray-600">システムの概要と統計情報</p>
        </div>
              ...
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    ...
                    <dd className="text-lg font-medium text-gray-900">51</dd>
                  </dl>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white overflow-hidden shadow rounded-lg">
            <div className="p-5">
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    <dt className="text-sm font-medium text-gray-500 truncate">総プロジェクト数</dt>
          ...
          <div className="bg-white overflow-hidden shadow rounded-lg">
            <div className="p-5">
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    <dt className="text-sm font-medium text-gray-500 truncate">総組織数</dt>
          ...
          <div className="px-4 py-5 sm:p-6">
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <p className="text-sm text-gray-600">新しいユーザー「田中部長」が登録されました</p>
                <span className="text-xs text-gray-400">2時間前</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-2 h-2 bg-blue-400 rounded-full"></div>
                <p className="text-sm text-gray-600">プロジェクト「モバイルアプリ開発」にメンバーが追加されました</p>
                <span className="text-xs text-gray-400">4時間前</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-2 h-2 bg-yellow-400 rounded-full"></div>
                <p className="text-sm text-gray-600">組織「Tech Division」が更新されました</p>
